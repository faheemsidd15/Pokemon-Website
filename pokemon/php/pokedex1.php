...
THIS IS WHERE THE CONTENT OF THE HTML WILL GO
		...
		<div class="input-group">
			...
			<div class="input-group-btn">
				<button class="btn btn-primary" id="btnSearch" value="Search Pokemon" type="submit">
...
<!--		<div>
			<button class="btn btn-sm btn-secondary ">Add/Change Pokemon</button>
		</div>-->
	...
	<center><h2 class="lead">Kanto League</h2></center>
